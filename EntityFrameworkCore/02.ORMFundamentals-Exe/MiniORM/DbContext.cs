namespace MiniORM
{
    ...
    public abstract class DbContext
    {
        ...
        internal static readonly Type[] AllowedSqlTypes =
       {
        ...
        protected DbContext(string connectonString)
        {
            this.connection = new DatabaseConnection(connectonString);
            this.dbSetProperties = this.DiscoverDbSets();

            using (new ConnectionMenager(connection))
            {
            ...
            where TEntity : class, new()
        {
            ...
            {
                this.connection.DeleteEntities(modifiedEntities, tableName, columns);
            }
        }
            ...
            where TEntity : class, new()
        {
            ...
            {
                var collectionType = c.PropertyType.GenericTypeArguments.First();

                var mapCollectionMethod = typeof(DbContext)
                    .GetMethod("MapCollection", BindingFlags.Instance | BindingFlags.NonPublic)
                    .MakeGenericMethod(entityType, collectionType);

                mapCollectionMethod.Invoke(this, new object[] { dbSet, c });
            }
        }
            ...
            where TCollection : class, new()
        {
            ...
            if (isManyToMany)
            {
                pKey = collectionType.GetProperties()
            ...
            foreach (var entity in dbSet)
            {
                ...
                var navigationEntities = navigationDbSet
                    .Where(navEntity => pKey.GetValue(navEntity).Equals(primaryKeyValue))
                    .ToArray();
